...
public class GoodreadRequest {
     ...
     */
    private void request(String url, final com.moringa.david.bookstore.network.SuccessFailCallback callback) {
     ...
     */
    public void getBook(Integer id, final com.moringa.david.bookstore.network.SuccessFailCallback callback) {
     ...
     * @param callback @param callback {@link SuccessFailedCallback} reference
     */
    public void getAuthor(Integer id, final com.moringa.david.bookstore.network.SuccessFailCallback callback) {
     ...
     * @param callback @param callback {@link SuccessFailedCallback} reference
     */
    public void searchBook(String query, final com.moringa.david.bookstore.network.SuccessFailCallback callback) {
