package com.moringa.david.bookstore.model;
...
public class AuthorBuilder {
     ...
     *
     * @param xmlString XML response string of a book from {@link com.moringa.david.bookstore.network.GoodreadRequest#getBook(Integer, com.moringa.david.bookstore.network.SuccessFailCallback)} API
     ...
     *
     * @param xmlString XML string from the {@link com.moringa.david.bookstore.network.GoodreadRequest#getAuthor(Integer, com.moringa.david.bookstore.network.SuccessFailCallback)} API
