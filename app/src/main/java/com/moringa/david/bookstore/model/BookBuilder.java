...
public class BookBuilder {
     ...
     *
     * @param xmlString XML response from {@link com.moringa.david.bookstore.network.GoodreadRequest#getBook(Integer, com.moringa.david.bookstore.network.SuccessFailCallback)} API
