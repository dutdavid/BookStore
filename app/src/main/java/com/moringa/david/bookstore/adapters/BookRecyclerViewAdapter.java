...
public class BookRecyclerViewAdapter extends RecyclerView.Adapter<BookRecyclerViewAdapter.BookViewHolder> {
    ...
    private List<com.moringa.david.bookstore.model.Book> values;

    public BookRecyclerViewAdapter(List<com.moringa.david.bookstore.model.Book> dataSet) {
        values = dataSet;
    }
    ...
    public void add(com.moringa.david.bookstore.model.Book item) {
    ...
    public void onBindViewHolder(final BookViewHolder holder, int position) {
        final com.moringa.david.bookstore.model.Book book = values.get(position);
        ...
        for (com.moringa.david.bookstore.model.Author i : book.getAuthors()) {
